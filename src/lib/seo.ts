...
export const META_RU = {
  ...
  ai: {
    ...
    description: "AI ассистент для подбора продуктов и рекомендаций. Спросите о каталоге, ценах и составе заказа — отвечает мгновенно.",
  },
}
...
export const META_KZ = {
  ...
  ai: {
    ...
    description: "Өнімдерді таңдауға арналған AI көмекші. Каталог, бағалар және тапсырыс туралы сұраңыз — жедел жауап береді.",
  },
}
