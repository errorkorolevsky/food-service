...
export const VALID_PRODUCT_IMAGES = new Set([
  ...
  // Magnum.kz source images (added 2026-05-29)
  "/products/apple-juice.webp",
  "/products/baby-juice-agusha.webp",
  "/products/baby-puree-apple-gerber.webp",
  "/products/black-tea-akbar.webp",
  "/products/butter-725.webp",
  "/products/cacao-nesquik.webp",
  "/products/canned-corn-bonduelle.webp",
  "/products/canned-peas-bonduelle.webp",
  "/products/canned-tuna-oil.webp",
  "/products/chicken-fillet.webp",
  "/products/chocolate-bar-milka.webp",
  "/products/chocolate-milk-drink.webp",
  "/products/coffee-ground-jacobs.webp",
  "/products/coffee-instant-nescafe.webp",
  "/products/cola.webp",
  "/products/crackers-rye.webp",
  "/products/curd-snack.webp",
  "/products/eggs-c0.webp",
  "/products/eggs-c1.webp",
  "/products/energy-redbull.webp",
  "/products/flour-premium.webp",
  "/products/green-tea-greenfield.webp",
  "/products/halva-sunflower.webp",
  "/products/iced-tea.webp",
  "/products/jubilee-cookies.webp",
  "/products/kefir-25.webp",
  "/products/kitkat.webp",
  "/products/lays-classic.webp",
  "/products/mayo-provencal.webp",
  "/products/milk-25.webp",
  "/products/milk-32.webp",
  "/products/nutella.webp",
  "/products/orange-juice.webp",
  "/products/oreo.webp",
  "/products/pelmeni-beef.webp",
  "/products/pepsi.webp",
  "/products/pizza-pepperoni-fresh.webp",
  "/products/rice-long.webp",
  "/products/snickers.webp",
  "/products/sour-cream-20.webp",
  "/products/spaghetti-barilla.webp",
  "/products/sugar-sand.webp",
  "/products/tomato-paste-pomidorka.webp",
  "/products/water-sparkling.webp",
  "/products/water-still.webp",
  "/products/yogurt-natural.webp",
])
